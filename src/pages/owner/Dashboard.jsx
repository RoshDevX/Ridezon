...
const Dashboard = () => {
  ...
  return (
    <div className="md:px-8 py-8 xl:py-8 m-1 sm:m-3 h-[97vh] overflow-y-scroll lg:w-11/12 bg-white shadow rounded-xl">
      <div className="grid grid-cols-2 gap-4">
        <div className="flexStart gap-7 p-5 bg-primaryOne lg:min-w-56 rounded-xl">
          <img src={assets.carBlack} alt="" className="hideen sm:flex w-8" />
          <div>
